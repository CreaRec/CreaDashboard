...
import { ensureSmtSyncSchedule, ensureWaterSyncSchedule, ensureAtmosSyncSchedule, ensureChampionSyncSchedule, ensureRestrictionsSyncSchedule, ensureCalendarSyncSchedule } from './schedules';
...
async function runWorker(): Promise<void> {
  ...
  await ensureRestrictionsSyncSchedule(client);
  await ensureCalendarSyncSchedule(client);
